...
The [six-hour Sarno result](../examples/wacomm-sarno-lite/docs/README.md) includes publication maps and profiles, downloadable vector figures, a serial Slurm workflow, and archived provenance.
