...
| Visualization and interaction | Plotting, animation, GUI, notebook examples, and an extensive gallery are first-class interfaces. | NetCDF outputs and documented command-line examples are primary; plotting is external. | Repository-native scientific figures and map schematics now document semantics. A tested trajectory-to-map tool remains future work. |
