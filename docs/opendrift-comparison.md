...
2. **Partially implemented:** provide explicit rectilinear and inverse-bilinear curvilinear geographic regridding with constant preservation, analytical cell-coordinate tests, antimeridian handling, fold detection, no extrapolation, Earth-relative vector semantics, and deterministic indexed curvilinear cell location. General projected-coordinate transforms and conservative remapping remain open.
