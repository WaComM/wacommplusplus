...
Set `sources.active:true` and `sources.sources_file:"examples/new-sources-campania_region/new-sources-campania_region.json"` in a complete run configuration, then execute:
